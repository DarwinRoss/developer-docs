    ...
    <div class="container margin-top-10 card-entry-form">
        ...
        <div id="ResponseMessageContainer" class="panel panel-success panel-success">
            <div class="panel-heading">Order Results</div>
                <div class="panel-body">
                <p><asp:Label ID="ResponseMessage" runat="server" /></p>
                <p><asp:Label ID="ReferenceNumber" runat="server" /></p>
                <p><asp:Label ID="KountScore" runat="server" /></p>
                <p><asp:Label ID="KountRecommendation" runat="server" /></p>
			...
			<div class="panel-body">
                ...
                <form id="PaymentForm" runat="server" class="form-horizontal">
                    <div class="form-group">
						...
						<div class="col-sm-9">
                            <asp:TextBox class="form-control" ID="EmailAddress" runat="server" placeholder="Enter Email Address"></asp:TextBox>
						</div>    
					</div>
...
<script>
    ...
    CayanCheckoutPlus.setWebApiKey("YOUR WEB API KEY HERE");
