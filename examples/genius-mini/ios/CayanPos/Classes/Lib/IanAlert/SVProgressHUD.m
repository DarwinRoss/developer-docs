...
- (id)initWithFrame:(CGRect)frame {
    ...
    if ((self = [super initWithFrame:frame])) {
        ...
        if ([[UIImage class] instancesRespondToSelector:@selector(imageWithRenderingMode:)]) {
          SVProgressHUDSuccessImage = [[UIImage imageNamed:@"badge_circle_success"] imageWithRenderingMode:UIImageRenderingModeAlwaysTemplate];
          SVProgressHUDErrorImage = [[UIImage imageNamed:@"badge_circle_fail"] imageWithRenderingMode:UIImageRenderingModeAlwaysTemplate];
        } else {
          SVProgressHUDSuccessImage = [UIImage imageNamed:@"badge_circle_success"];
          SVProgressHUDErrorImage = [UIImage imageNamed:@"badge_circle_fail"];
        }
...
- (id)initWithFrame:(CGRect)frame {
    if (self = [super initWithFrame:frame]) {
        ...
        self.strokeColor = [UIColor colorWithRed:0.082 green:0.396 blue:0.455 alpha:1.000];//SVProgressHUDForegroundColor;
    }
    return self;
}
