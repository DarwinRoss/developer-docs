...
//  Copyright © 2015 HJaycee. All rights reserved.
...
#define JCAlertViewWidth [UIScreen mainScreen].bounds.size.width-40
...
- (void)addCoverView{
    ...
    self.coverView.backgroundColor = [UIColor colorWithWhite:0.408 alpha:1.000];//JCColor(5, 0, 10);
